package cc.vastsea.zrll.ncmdumpercompose.pages
...
@Composable
fun MusicPage(paddingValues: PaddingValues) {
...
private fun NcmFileItem(file: NcmFile) {
    Card(
        ...
        Column(
            ...
            Text(
                text = "${FormatUtils.formatNcmName(file.name).first}・${FormatUtils.formatSize(file.size)}",
